...
const CreateContentStyled = styled.form`
  ...
  color: ${(props) => props.theme.theme.colorGrey1};
  ...
  .input-control {
    ...
    textarea {
      ...
      resize: none;
      background-color: ${(props) => props.theme.theme.colorGreyDark};
  ...
  .submit-btn button {
    ...
    &:hover {
      background: ${(props) => props.theme.theme.colorPrimaryGreen} !important;
      color: ${(props) => props.theme.theme.colorWhite} !important;
    }
  }
